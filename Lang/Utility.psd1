ConvertFrom-StringData @"
    ...
    CreatePlotInProgress = The creation process is in progress...
    LogsInProgress = Current logs in directory:
    ProcessID = Process id:
    PathTempNotFound = You did not fill in the config.yaml file correctly
    ...
    ProcessMoveClosedImpossibleEnter = Press ENTER to exit...
